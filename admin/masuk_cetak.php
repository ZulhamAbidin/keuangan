							    ...
							    <table id="laporanTable" class="table table-bordered">
							  	...
							  	<tbody>
							  		...
							  		<?php
										...
										$query1 = mysqli_query($koneksi, "SELECT sum(jumlah_masuk) as jumlahMasuk FROM data_masuk WHERE tanggal_masuk BETWEEN '$tanggal1' AND '$tanggal2'");
										$data1  = mysqli_fetch_array($query1);
									?>
							  		<tr>
							  			<td colspan="3">Total Pemasukan</td>
							  			<td>Rp. <?= number_format($data1['jumlahMasuk']); ?></td>
							  		</tr>
							  	</tbody>
							  </table>
						</div>
