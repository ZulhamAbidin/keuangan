          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-primary" onclick="tampilkanGambar('<?php echo $data['gambar']; ?>')"><i class="fe fe-eye"></i></button>
                </td>
                <td>
                  <a href="masuk_edit.php?id_masuk=<?php echo $data['id_masuk']; ?>" class='btn btn-primary btn-sm'><span
                      aria-hidden="true"></span>Edit</a>
                  <a href="#" class="btn btn-sm btn-danger shadow-sm" onclick="showDeleteAlertMasuk('<?php echo $data['id_masuk']; ?>')">
