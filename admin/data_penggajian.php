...
<div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    // Gunakan SweetAlert untuk tampilan alert yang lebih baik
    Swal.fire({
        title: 'Peringatan',
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function(response) {
                    // Tampilkan pesan SweetAlert berdasarkan respons dari server
                    Swal.fire('Terhapus!', response, 'success').then((result) => {
                        // Refresh halaman jika pengguna menekan OK pada SweetAlert
                        if (result.isConfirmed) {
                            location.reload();
                        }
                    });
            ...
            // Kembalikan false agar hyperlink tidak mengarahkan ke URL
            return false;
        } else {
            // Jika pengguna membatalkan, Anda mungkin ingin memberikan umpan balik atau melakukan tindakan lain
