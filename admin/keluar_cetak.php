...
$query = mysqli_query($koneksi, "SELECT * FROM data_keluar WHERE tanggal_keluar BETWEEN '$tanggal1' AND '$tanggal2'");
$data = [];
...
$totalPengeluaran = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT SUM(jumlah) as jumlahPengeluaran FROM data_keluar WHERE tanggal_keluar BETWEEN '$tanggal1' AND '$tanggal2'"));
?>
